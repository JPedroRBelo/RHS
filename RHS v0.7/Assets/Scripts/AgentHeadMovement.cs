                ...
                case Action.HeadFocus:
                    ...
                    switch (command.getActionStateID())
                    {
                        ...
                        case (int)HeadFocus.Position:
                            ...
                            {
                                Debug.Log("Command>>> " + this.name + " command " + command.getId() + " Failed! Obj. is not visible.");
                                command.fail();
                            }
                            break;
                ...
                case Action.HeadReset:
                    switch (command.getActionStateID())
                    {
                        ...
                        case (int)HeadReset.Position:
                            ...
                            if (animator.GetFloat("HeadReach") < 0.25)
                            {
                                Debug.Log("Command>>> " + this.name + " command " + command.getId() + " Success!");
                                command.success();
                            }
                ...
                case Action.LookFor:
                    switch (command.getActionStateID())
                    {
                        ...
                        case (int)LookFor.Search:
                            ...
                            {
                                Debug.Log("Command>>> " + this.name + " command " + command.getId() + " Failed! " + command.getRefName() + " Not found.");
                                command.fail();
                            }
                            break;
